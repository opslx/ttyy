...
export {}
declare global {
  const ButtonPermission: typeof import('../src/store/permission')['ButtonPermission']
  const EffectScope: typeof import('vue')['EffectScope']
  const SortRouters: typeof import('../src/hooks/use-permission')['SortRouters']
  const addRouter: typeof import('../src/api/user')['addRouter']
  ...
  const filterAsyncRouterByOther: typeof import('../src/hooks/use-permission')['filterAsyncRouterByOther']
  ...
  const getCookieRefresh: typeof import('../src/utils/cookie')['getCookieRefresh']
  const getCookieToken: typeof import('../src/utils/cookie')['getCookieToken']
  ...
  const getUsers: typeof import('../src/api/user')['getUsers']
  ...
  const loginOut: typeof import('../src/api/user')['loginOut']
  ...
  const rbacPermission: typeof import('../src/directives/rbac-permission')['default']
  const reactive: typeof import('vue')['reactive']
  const readonly: typeof import('vue')['readonly']
  const ref: typeof import('vue')['ref']
  const removeCookieRefresh: typeof import('../src/utils/cookie')['removeCookieRefresh']
  const removeCookieToken: typeof import('../src/utils/cookie')['removeCookieToken']
  ...
  const resetToken: typeof import('../src/api/user')['resetToken']
  ...
  const setCookieRefresh: typeof import('../src/utils/cookie')['setCookieRefresh']
  const setCookieToken: typeof import('../src/utils/cookie')['setCookieToken']
  ...
  const userInfo: typeof import('../src/api/user')['userInfo']
  const userRoute: typeof import('../src/api/user')['userRoute']
